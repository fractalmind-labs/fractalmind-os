...
## This repo defines
- file contract
- skill contract（package minimum + source + install）
- runtime contract
- packaging contract
...
4. 再读 `contracts/skills/skill-package-minimum.md`、`contracts/skills/skill-source.md` 和 `contracts/skills/skill-install.md`
