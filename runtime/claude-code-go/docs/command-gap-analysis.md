...
### 下一步要补的高频子路径：direct-connect 的最小 `task_started / task_progress / task_notification` path
...
2. session_state_changed 最小 running/idle 已收口后，下一批真实缺口已转到 `task_started / task_progress / task_notification` 等其它消息形状
