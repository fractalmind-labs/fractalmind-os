...
### 下一步要补的高频子路径：direct-connect 的更完整 system 状态机 / 其它 message 类型
...
2. hook 生命周期最小 started/progress/response 已收口后，下一批真实缺口已转到更完整的 system 子类型 / 其它消息形状
