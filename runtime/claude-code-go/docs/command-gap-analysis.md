...
- 理由：`attachment:task_status` 已补齐，下一批真实缺口会转到更丰富 task lifecycle 语义或其它仍未覆盖的 attachment/message family，而不是继续重复已收口的 success-task status shape。
