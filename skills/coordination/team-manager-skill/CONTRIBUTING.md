# Contributing to Team Manager Skill

Thank you for your interest in contributing to Team Manager Skill! This document provides guidelines and instructions for contributing to the project.
...
```bash
# Clone your fork
git clone https://github.com/your-username/team-manager-skill.git
cd team-manager-skill
...
python3 team-manager/scripts/main.py list
```
